...
//    private String url = "https://zsb.xmut.edu.cn/__local/2/AE/1D/EBE7F20862DB01E30531A5F2AC1_7C45D05A_5EF3DBE.mp4?e=.mp4";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        if (arguments != null) {
            ...
            String[] subNameList = arguments.getStringArray("subNameList");
            String[] subVideoList = arguments.getStringArray("subVideoList");
            ...
            fragmentList.add(new VideoListFragment(subNameList, subVideoList, this));
